...
- Payment and paid-access gates are disabled for booking-flow testing.

No tracker-service client picker, payment checkout, Telegram integration, admin validation, or outbound observability service is used.
